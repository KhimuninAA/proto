...
public extension Google.Protobuf {
    ...
    enum AccessControl:Int32, GeneratedEnum {
    ...
    enum RealmOverrideRepeated:Int32, GeneratedEnum {
        case `override` = 0
        case append = 1
        public func toString() -> String {
            switch self {
    ...
    final class LinkedObject : GeneratedMessage {
    ...
    final class SwiftFileOptions : GeneratedMessage {
    ...
    final class SwiftMessageOptions : GeneratedMessage {
    ...
    final class SwiftFieldOptions : GeneratedMessage {
    ...
    final class SwiftEnumOptions : GeneratedMessage {
